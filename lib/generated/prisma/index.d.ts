...
export namespace Prisma {
  ...
  */
  ...
  export type ToolOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "description" | "channel" | "config" | "workspaceId" | "elevenLabsToolId" | "createdAt" | "updatedAt", ExtArgs["result"]["tool"]>
  ...
  interface ToolFieldRefs {
    ...
    readonly channel: FieldRef<"Tool", 'String'>
  ...
  export type ToolWhereInput = {
    ...
    channel?: StringFilter<"Tool"> | string
  ...
  export type ToolScalarWhereWithAggregatesInput = {
    ...
    channel?: StringWithAggregatesFilter<"Tool"> | string
